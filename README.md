...
```bash
python dev_server.py # Flask (Native)
python prod_asgi_server.py # ASGI
python prod_wsgi_server.py # WSGI

or

launch start_dev_server.bat
launch start_prod_asgi_server.bat
launch start_prod_wsgi_server.bat
```
